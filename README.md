...
[![Der K-Macher zieht einen großen Vorhang auf und zeigt eine Steuerkanzlei mit ihren Leistungen und ihrer Arbeitsweise](assets/duerfen-steuerberater-werbung-machen-illustrations/pixel-art/03-kanzlei-sichtbar-machen.webp)](https://klarmodus.de/ratgeber/duerfen-steuerberater-werbung-machen/)
...
| --- | --- |
| [![Eine Idee konkret machen als Handzeichnung](examples/images/06-idea-press.png)](examples/images/06-idea-press.png) | [![Eine Idee konkret machen als Pixel-Art](examples/images-pixel/06-idea-press.png)](examples/images-pixel/06-idea-press.png) |
...
[![Der K-Macher zeigt liegen gebliebene Ideen und einen fehlenden nächsten Schritt](examples/images/01-two-breakpoints.png)](examples/images/01-two-breakpoints.png)
...
[![Der K-Macher sortiert Inhalte nach Reichweite, Vertrauen und Anfragen](examples/images/02-sort-by-purpose.png)](examples/images/02-sort-by-purpose.png)
...
[![Aus einem Thema entstehen ein Kurzbeitrag, ein Praxisbeispiel, ein Blogartikel und ein Angebot](examples/images/03-one-fish-many-uses.png)](examples/images/03-one-fish-many-uses.png)
...
[![Der K-Macher verbindet einen Artikel mit Kontakt, vertiefenden Informationen und einem Angebot](examples/images/04-handoff-path.png)](examples/images/04-handoff-path.png)
...
[![Der K-Macher wählt aus einer großen Wissenssammlung brauchbare Ideen aus](examples/images/05-information-well.png)](examples/images/05-information-well.png)
...
[![Der K-Macher formt aus einer vagen Idee einen ersten Test](examples/images/06-idea-press.png)](examples/images/06-idea-press.png)

[Handzeichnung](examples/images/06-idea-press.png) · [Pixel-Art](examples/images-pixel/06-idea-press.png)

### Wissen weiterentwickeln

[![Der K-Macher hält Erfahrungen fest und entwickelt wiederverwendbare Wissensbausteine](examples/images/07-content-fermentation.png)](examples/images/07-content-fermentation.png)
...
[![Der K-Macher baut aus Praxisbeispielen und Arbeitsproben eine Brücke zum Gespräch](examples/images/08-trust-bridge.png)](examples/images/08-trust-bridge.png)
